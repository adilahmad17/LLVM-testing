...
enum : SanitizerMask {
  ...
  NeedsUnwindTables = Address | HWAddress | Thread | Overwatch | Memory | DataFlow,
...
SanitizerArgs::SanitizerArgs(const ToolChain &TC,
  ...
  std::pair<SanitizerMask, SanitizerMask> IncompatibleGroups[] = {
      std::make_pair(Address, Thread | Overwatch | Memory),
      std::make_pair(Thread | Overwatch, Memory),
      std::make_pair(Leak, Thread | Overwatch | Memory),
      std::make_pair(KernelAddress, Address | Leak | Thread | Overwatch | Memory),
      std::make_pair(HWAddress, Address | Thread | Overwatch | Memory | KernelAddress),
      std::make_pair(Efficiency, Address | HWAddress | Leak | Thread | Overwatch | Memory |
                                     KernelAddress),
      std::make_pair(Scudo, Address | HWAddress | Leak | Thread | Overwatch | Memory |
                                KernelAddress | Efficiency),
      std::make_pair(SafeStack, Address | HWAddress | Leak | Thread | Overwatch | Memory |
                                    KernelAddress | Efficiency),
      std::make_pair(ShadowCallStack, Address | HWAddress | Leak | Thread | Overwatch |
                                          Memory | KernelAddress | Efficiency |
                                          SafeStack),
      std::make_pair(KernelHWAddress, Address | HWAddress | Leak | Thread | Overwatch |
                                          Memory | KernelAddress | Efficiency |
